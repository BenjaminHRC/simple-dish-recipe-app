                ...
                <div class="flex flex-col md:flex-row justify-between md:items-center flex-1 gap-6">
                    <div class="flex flex-row md:flex-col justify-between items-start gap-2">
                        <div class="flex items-center gap-5">
                            ...
                            <a href="{{ route('dish.add.favorite', ['dish' => $paginateDish->id]) }}"
                                class="cursor-pointer">
                                @if ($paginateDish->isFavorite)
                    ...
                    <div class="flex flex-col gap-5">
                        <a href="{{ route('dish.edit', ['dish' => $paginateDish->id]) }}">
                        ...
                        <a href="{{ route('dish.destroy', ['dish' => $paginateDish->id]) }}">
                            <svg class="cursor-pointer" style="fill: #b16a6d;" width="24px" height="24px"
                                xmlns="http://www.w3.org/2000/svg"
